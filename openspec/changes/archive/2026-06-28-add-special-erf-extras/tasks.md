...
- [x] declarations in `include/scypp/special/special.hpp` (`fresnel_t`, scalar entry points, `ndarray` overloads of `erfcx`/`dawsn`); wire `erf_extras.cpp` into `src/CMakeLists.txt`
