#pragma once
// Internal helpers for scypp::optimize: ndarray<->vector conversion and
...
namespace scypp::optimize::detail {

inline std::vector<double> tov(const ndarray& a) { return scypp::linalg::detail::to_vec(a); }
inline ndarray tond(const std::vector<double>& v) { return scypp::linalg::detail::from_vec(v); }
