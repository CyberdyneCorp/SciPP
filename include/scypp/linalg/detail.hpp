#pragma once
// Internal helpers for scypp::linalg: convert between numpp::ndarray and plain
...
inline std::vector<double> to_mat(const numpp::ndarray& a, int64_t& rows, int64_t& cols) {
  if (a.ndim() != 2) throw scypp::value_error("expected a 2-D matrix");
